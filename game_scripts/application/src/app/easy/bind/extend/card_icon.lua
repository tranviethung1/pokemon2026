...
--闪光图标
function cardIcon:setSg(panel)
	ccui.ImageView:create("common/txt/txt_sg.png")
		:align(cc.p(0.5, 0.5), 108, 178)
		:addTo(panel, 14, "sg")
		:scale(0.64)
		:hide()
	helper.callOrWhen(self.unitId or self.cardId, function(id)
		...
		panel:get("sg"):visible(cardCsv and cardCsv.cardType == 3)
	end)
end
--远古图标
function cardIcon:setYgys(panel)
	ccui.ImageView:create("common/txt/txt_ygys.png")
		:align(cc.p(0.5, 0.5), 100, 22)
		:addTo(panel, 14, "ygys")
		:scale(0.64)
		:hide()
	helper.callOrWhen(self.unitId or self.cardId, function(id)
		...
		panel:get("ygys"):visible(cardCsv and cardCsv.cardType == 4)
	end)
end
--究极图标
function cardIcon:setJjys(panel)
	ccui.ImageView:create("common/txt/txt_jjys.png")
		:align(cc.p(0.5, 0.5), 100, 22)
		:addTo(panel, 14, "jjys")
		:scale(0.64)
		:hide()
	helper.callOrWhen(self.unitId or self.cardId, function(id)
		...
		panel:get("jjys"):visible(cardCsv and cardCsv.cardType == 5)
	end)
end

--联动图标
function cardIcon:setLiandong(panel)
	ccui.ImageView:create("common/txt/liandong.png")
		:align(cc.p(0.5, 0.5), 100, 22)
		:addTo(panel, 14, "liandong")
		:scale(0.64)
		:hide()
	helper.callOrWhen(self.unitId or self.cardId, function(id)
		local unitCsv = csv.unit[id]
		...
		panel:get("liandong"):visible(cardCsv and cardCsv.cardType == 6)
	end)
end
return cardIcon