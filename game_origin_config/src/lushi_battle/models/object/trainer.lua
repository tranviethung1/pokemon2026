slot0 = class("AutoChessTrainerModel", AutoChessBattle.ObjectBaseModel)
AutoChessBattle.Trainer = slot0

function slot0.ctor(slot0, slot1, slot2)
	AutoChessBattle.ObjectBaseModel.ctor(slot0, slot1)
...
function slot0.resetRole(slot0, slot1)
	...
	for slot7, slot8 in csvPairs(slot0.cfg.hp) do
		if slot7 <= slot0.level and 0 <= slot7 then
			slot3 = slot7
			slot2 = slot8
		end
	end
...
function slot0.reset(slot0)
	AutoChessBattle.ObjectBaseModel.reset(slot0)
