...
function bcopy(slot0, slot1, slot2)
	uv3 = "copy"

	slot3.copy(slot1, slot0, slot2)
end

function bcmp(slot0, slot1, slot2)
...
function memset(slot0, slot1, slot2)
	uv3 = "fill"
...
function memcpy(slot0, slot1, slot2)
	uv3 = "copy"

	slot3.copy(slot0, slot1, slot2)
end

function memcmp(slot0, slot1, slot2)
	uv3 = "cast"
	slot4 = "const uint8_t *"
	uv4 = "cast"
...
function memchr(slot0, slot1, slot2)
	uv3 = "cast"
...
function memmove(slot0, slot1, slot2)
	uv3 = "cast"
