...
function slot1.init(slot0)
	for slot4, slot5 in ipairs(battleModule.mods) do
		table.insert(slot0.mods, slot5.new(slot0.view))
	end
end

function slot1.addSpec(slot0, slot1)
	for slot5, slot6 in ipairs(slot1) do
		table.insert(slot0.mods, slot6.new(slot0.view))
	end
end
