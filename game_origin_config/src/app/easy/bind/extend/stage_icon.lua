...
slot1 = class("stageIcon", cc.load("mvc").ViewBase)
slot1.defaultProps = {
	showRank = false,
	showStageBg = false,
	showStage = true
...
function slot1.initExtend(slot0)
	...
	slot3.callOrWhen(slot0.rank, function (slot0)
		slot4 = dataEasy.getCrossArenaStageByRank(slot0).icon
		uv4 = "dataEasy"
		slot4 = 2
		slot2 = ccui.ImageView:create(slot4):xy(slot4.width / 2, 118):scale(slot4)
		slot3 = slot2
		uv4 = "getCrossArenaStageByRank"
		...
		if slot3.showStage then
			...
			slot4 = label.create(slot3.showRank == false and slot1.stageName or slot1.stageName .. slot1.rank, slot6):x(slot6):y(slot6):setHorizontalAlignment(slot6)
			slot5 = slot4
			uv6 = "getCrossArenaStageByRank"
			uv5 = "ccui"
