...
slot2 = class("CardStarOneKeyView", Dialog)
...
function slot2.onCreate(slot0, slot1, slot2, slot3)
	...
	slot0:initModel()
	slot0.title:hide()
	slot0.titleTxt2:text(gLanguageCsv.starUp)
	...
	slot0.currLevelLimit = slot4.abilityMax
	slot10 = slot0.equipData.equip_id
	slot11 = (slot0.equipData.ability or 0) + 1
	slot12 = {}
	slot13 = 0
	slot14 = true

	for slot18 = slot9, slot8 - 1 do
		for slot23, slot24 in csvMapPairs(csv.base_attribute.equip_ability[slot18]["costItemMap" .. slot4.abilitySeqID]) do
			if slot23 == "gold" then
...
function slot2.onReduceClick(slot0)
	...
	slot0.selectLv:set(math.max(slot0.equipData.ability + 1, slot5.read(slot6) - slot6))
end
...
function slot2.onSureClick(slot0)
	...
	gGameApp:requestServerCustom("/game/equip/ability"):params(slot0.selectDbId, slot1.part, slot0.selectLv:read() - slot0.equipData.ability):onResponse(function ()
		error("Decompilation failed")
		-- Exception in function building!
		-- Traceback (most recent call last):
		-- File "/home/hungtv/megamon2024/luajit-decompiler/ljd/ast/builder.py", line 856, in _build_function
