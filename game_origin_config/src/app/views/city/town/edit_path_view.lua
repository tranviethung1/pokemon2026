...
function slot7.onCreate(slot0)
	...
	slot0:initModel()
	slot0.btnPath:visible(false)
	slot0.bg:get("map2"):visible(false)
...
function slot7.drawLine(slot0, slot1, slot2)
	...
	if not slot0.bg:get("map"):get("DrawNode" .. slot2) then
		slot0.bg:get("map"):addChild(cc.DrawNode:create(), 20, "DrawNode" .. slot2)
	end
...
function slot7.addPosItem(slot0, slot1, slot2)
	...
	slot0.bg:get("map"):addChild(slot3, 25)
...
function slot7.drawNode(slot0, slot1, slot2)
	...
	if not slot0.bg:get("map"):get("DrawNode" .. slot2) then
		slot0.bg:get("map"):addChild(cc.DrawNode:create(), 25, "DrawNode" .. slot2)
	end
	...
	for slot6, slot7 in ipairs(slot0.selectPosList) do
		...
		if slot0.selectPosPathList[slot6] and #slot0.selectPosPathList[slot6] > 0 then
			slot8 = function (slot0)
				for slot5, slot6 in ipairs(slot0) do
					slot10 = ";info=<"
					slot1 = "<" .. "{lastPoint=" .. slot6.lastPoint .. slot10
		...
		slot2 = slot2 .. string.format("%d   <%d;%d>   %s\n", slot6, slot7.x, slot7.y, slot8)
	end

	slot3 = io.open("npc_path.txt", "w+")

	slot3:write(slot2)
	slot3:flush()
	slot3:close()
	gGameUI:showTip("save is success, text name is npc_path.txt")
end
