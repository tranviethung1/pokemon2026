...
slot3 = class("HellRandomTowerUseBuffView", Dialog)
...
function slot3.onCreate(slot0, slot1, slot2)
	...
	slot5 = csv.hell_random_tower.buffs[slot4]
	slot0.boardID = slot1
	slot0.buffId = slot4
	uv10 = "initModel"
	...
	if slot5.supplyTarget == 2 then
		for slot11, slot12 in pairs(gGameModel.hell_random_tower:read("battle_cards")) do
			slot13 = slot0.cardStates
			slot14 = slot13
			uv14 = "cb"

			if slot14.reachConditionEx(slot5.condition, slot13.read(slot14)[slot12]) then
				table.insert(slot6, slot0:getCardData(slot12))
			end
		end
	else
		for slot11, slot12 in pairs(gGameModel.hell_random_tower:read("prepare_cards")) do
			slot13 = slot0.cardStates
			slot14 = slot13
			uv14 = "cb"

			if slot14.reachConditionEx(slot5.condition, slot13.read(slot14)[slot11]) then
				table.insert(slot6, slot0:getCardData(slot11))
			end
		end
	end
...
function slot3.getCardData(slot0, slot1)
	...
	slot6 = csv.hell_random_tower.cards[slot1]
	slot8 = csv.cards[slot6.cardID].cardMarkID
	slot9 = dataEasy.getUnitId(slot6.cardID, gGameModel.hell_random_tower:read("prepare_cards")[slot1])
...
function slot3.initModel(slot0)
	slot0.cardStates = gGameModel.hell_random_tower:getIdler("card_states")
...
function slot3.onBtnSure(slot0)
	...
	gGameApp:requestServerCustom("/game/hell_random_tower/buff/used"):params(slot1.csvID):onResponse(function ()
