...
slot5 = class("HellRandomTowerOpenBoxView", cc.load("mvc").ViewBase)
...
function slot5.onCreate(slot0, slot1, slot2)
	...
	for slot9, slot10 in orderCsvPairs(csv.hell_random_tower.box) do
		if slot10.version == csv.hell_random_tower.theme[gGameModel.hell_random_tower:read("theme")].awardVersion and slot10.index == csv.hell_random_tower.board[slot1].boxIndex then
			slot0.boxType = slot10.boxType
	...
	slot8 = slot0.boxType
	slot6 = gCommonConfigCsv["randomTowerBoxLimit" .. slot8] + 1
	slot0.boxLimit = slot6
	uv6 = "boardID"
	slot6 = slot6.setEffect
	uv8 = "cb"
	slot8 = slot8[slot0.boxType]

	slot6(slot0.titlePos, slot8, "random_tower/baoxiang.skel", 770)

	uv6 = "boardID"
	uv8 = "initModel"

	slot6.setEffect(slot0.boxPos, slot8[slot0.boxType], "random_tower/baoxiang.skel", 240)
	idlereasy.any({
		slot0.roomInfo,
		slot0.rmb
		...
		uv9 = "count"
		slot8 = "hell_random_tower_box_cost" .. slot9.boxType
...
function slot5.onBtnOpen(slot0)
	...
	if slot1 and slot1 > 0 then
		...
		dataEasy.sureUsingDiamonds(function ()
			...
			gGameApp:requestServer("/game/hell_random_tower/box/open", function (slot0)
				uv1 = "setEffect"
				uv2 = "boxPos"
				slot2 = slot2.boxPos
				uv3 = "boxType"
...
function slot5.onBtnNext(slot0)
	...
	gGameApp:requestServer("/game/hell_random_tower/next", function (slot0)
