...
slot1 = class("SignInShopItem", slot0)
...
function slot1.isShowCondition(slot0, slot1)
...
function slot1.getstartBuyInfo(slot0, slot1, slot2)
	...
	return "num", (slot1.type ~= 1 or math.huge) and slot1.itemCount
end
