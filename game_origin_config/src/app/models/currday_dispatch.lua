slot0 = class("CurrDayDispatch", require("app.models.base"))

function slot0.init(slot0, slot1)
	slot2 = {
		[slot6] = idlereasy.new(userDefault.getCurrDayKey(slot6, slot7), slot6)
	}
	...
	for slot6, slot7 in pairs(slot1) do
		idlereasy.when(slot2[slot6], function (slot0, slot1)
			...
			userDefault.setCurrDayKey(slot3, slot1)
		end)
	end
